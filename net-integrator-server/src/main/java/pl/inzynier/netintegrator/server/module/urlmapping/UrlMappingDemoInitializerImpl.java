 ...
 */
@Component
class UrlMappingDemoInitializerImpl implements UrlMappingDemoInitializer {
    ...
    @Autowired
    public UrlMappingDemoInitializerImpl(UrlMappingRepository mappingRepository, ScriptService scriptService) {
    ...
    @PostConstruct
	public
    void initializeDemo() throws ScriptServiceException {
